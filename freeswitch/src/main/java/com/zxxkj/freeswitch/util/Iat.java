package com.zxxkj.freeswitch.util;
...
public class Iat {
	...
	public static void main(String[] args) {
		...
		//音频文件
		File file = new File("F:/RECORD_e37a67752da336ba8dfec45b696e8a50.wav");
		...
		//ApiKey创建应用时自动生成
		String apiKey = "74859cce257f4237bfe396a5fc6f3a3b";
