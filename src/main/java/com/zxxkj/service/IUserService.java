...
public interface IUserService {
	 ...
	 * @return
	 */
	int updateActiveById(int userId, int isActive);
	
	/**
	 * 根据账号查询用户
	 * @return
	 */
	List<User> findUserListByAdminId(int adminId, int start, int count, String account);
	...
	/**
	 * 根据userIdList将这些用户账户的状态修改为到期状态
	 * @param userIdList
	 * @return
	 */
	int updateActiveByUserIdList(List<Integer> userIdList, int isActive);
	 ...
	 * @return
	 */
	int updateValidTime(int userId, String validTime);
